...
const Menu: FC<MenuProps> = ({ className }) => (
  <div
    className={`${className} fixed top-0 left-0 w-[20%] h-[100vh] transition overflow-auto overscroll-auto scroll-smooth flex flex-col p-2 gap-2 shadow-xl min-h-screen bg-neutral-50 dark:bg-neutral-900`}
  >
