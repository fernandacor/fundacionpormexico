const spanishMessages = {
  ra: {
    ...
    message: {
      ...
      bulk_delete_content:
        "¿Seguro que quiere eliminar este %{name}? |||| ¿Seguro que quiere eliminar estos %{smart_count} objetos?",
      bulk_delete_title:
        "Eliminar %{name} |||| Eliminar %{smart_count} %{name} objetos",
      bulk_update_content:
        "¿Seguro que quiere actualizar este %{name}? |||| ¿Seguro que quiere actualizar estos %{smart_count} objetos?",
      bulk_update_title:
        "Actualizar %{name} |||| Actualizar %{smart_count} %{name} objetos",
      clear_array_input: "¿Estás seguro de que quieres borrar toda la lista?",
      delete_content: "¿Seguro que quiere eliminar este objeto?",
